...
@CrossOrigin
@RestController
public class AssessmentItemManagementController {
	@Autowired
	AssessmentItemManagementAppVerNoDispatcher assessmentItemManagementAppVerNoDispatcher;
	@Autowired
	DataCenterService dataCenterService;

	@PreAuthorize("hasAuthority('performance_appraisals_manage')")
	...
	public Object home(HttpServletRequest request,HttpServletResponse response){
		...
		assessmentItemManagementAppVerNoDispatcher.dispatchByAppVerNo(requestParamJson,responseData);
		return responseData;
	}
