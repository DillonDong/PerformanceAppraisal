...
@Component
public class FileUploadAppVerNoDispatcher {
	@Autowired
	FileUploadFunctionNoDispatcher fileUploadFunctionNoDispatcher;
	public Object dispatchByAppVerNo(JSONObject requestParamJson, ResponseData responseData) {
		...
		switch (appVerNo) {
		case "1.0.0":
			fileUploadFunctionNoDispatcher.dispatchByFunctionNo(functionNo,responseData);
			break;
